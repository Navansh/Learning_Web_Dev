...
const Template = ({title, desc1 ,desc2, image, formType, setIsLoggedIn}) => {
  return (
    ...
    <div className=' flex w-11/12 justify-between  max-w-[1160px] mx-auto py-12 gap-x-12 gap-y-0'>
        <div className=' w-full max-w-[450px] mx-0 '>
            ...
            <button className=' w-full flex justify-center items-center rounded-[8px] font-medium text-richblack-100 border border-richblack-700 px-3 py-2 gap-x-2 mt-6'>
                <FcGoogle/>
